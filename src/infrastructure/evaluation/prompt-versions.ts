import { Occasion, Vibe } from '@/domain/styling/model';

export type PromptVersion = 'P0' | 'P1' | 'P2' | 'P3';
...
const vibeText: Record<Vibe, string> = {
  ...
  DANDY: 'modern Korean dandy: refined smart casual, relaxed tailoring, sophisticated and understated',
  ...
  GORPCORE: 'urban gorpcore: technical outdoor clothing, functional layering and restrained utility details',
};
