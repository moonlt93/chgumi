...
const ACTIONS = [
  { id: 'wave', label: '인사하기', message: '오늘도 만나서 반가워요!' },
  { id: 'jump', label: '점프하기', message: '작은 한 걸음도 멋져요!' },
  { id: 'stretch', label: '기지개 켜기', message: '잠깐 쉬어가도 괜찮아요.' },
] as const;
  ...
  return (
    <section className="interactive-room">
      ...
      <p className="avatar-message" role="status">
        {action ? action.message : '아바타를 톡 눌러보세요'}
      </p>
