...
import { PhotoPicker } from '@/presentation/styling/components/PhotoPicker';
...
export default function Photo() {
  const { image, nextFromPhoto } = useStylingFlow();
  ...
  return (
    <Screen>
      ...
      />
      <PhotoPicker />
      <PrimaryButton disabled={!image} onClick={nextFromPhoto} className="mt-6">
        다음
      </PrimaryButton>
    </Screen>
  );
